...
class _SearchWState extends State<SearchW> {
  ...
  final List<String> wl = ['down','heat','increase','kitchen','lights','switch','temperature','turn','volume','up'];
      ...
      body: ListView(
        children: [
          ...
          Container(
              ...
              child: Center(child: Text("Find 5 words to win!", style: TextStyle(color: Colors.blueGrey, fontSize: 40, )),)
          ),
