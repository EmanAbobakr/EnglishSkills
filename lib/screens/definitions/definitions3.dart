...
import 'defintion4.dart';

class Definitions3 extends StatefulWidget {
  @override
  _Definitions3State createState() => _Definitions3State();
}

class _Definitions3State extends State<Definitions3> {
  ...
  bool isPresent(String text) {
    return Data().listCorrect3.contains(text);
  }

  @override
  Widget build(BuildContext context) {
    var element = Data().listOfSent3[rnd.nextInt(Data().listOfSent3.length)];
    return Scaffold(
