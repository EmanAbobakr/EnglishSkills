...
import 'defintions2.dart';

class DefinitionsScreen extends StatefulWidget {
  @override
  _DefinitionsScreenState createState() => _DefinitionsScreenState();
}
...
class _DefinitionsScreenState extends State<DefinitionsScreen> {
  ...
  bool isPresent(String text) {
    return Data().listCorrect.contains(text);
  }

  @override
  Widget build(BuildContext context) {
    var element = Data().listOfSent[rnd.nextInt(Data().listOfSent.length)];
    return Scaffold(
