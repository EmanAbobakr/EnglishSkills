...
class Definitions4 extends StatefulWidget {
  @override
  _Definitions4State createState() => _Definitions4State();
}

class _Definitions4State extends State<Definitions4> {
  ...
  bool isPresent(String text) {
    return Data().listCorrect4.contains(text);
  }

  @override
  Widget build(BuildContext context) {
    var element = Data().listOfSent4[rnd.nextInt(Data().listOfSent4.length)];
    return Scaffold(
