...
class EnglishScreen2 extends StatefulWidget {
  @override
  _EnglishScreen2State createState() => _EnglishScreen2State();
}

class _EnglishScreen2State extends State<EnglishScreen2> {
  String sentence;
                  ...
                  child: FlatButton(
                    onPressed: () {
                      Navigator.pushReplacement(context,
                        MaterialPageRoute(
                            builder: (context) => EnglishScreen3()),
                      );
                    },
                    color: Colors.blue,
                    textColor: Colors.white,
      ...
      body: ListView(
        children: [
          ...
          Container(
            ...
            child: Image.asset("assets/images/boy.jpg", fit: BoxFit.fill),
          ),
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                FlatButton(
                  onPressed: () {
                    Future<String> res = http_service().GetData(sentence,2);
